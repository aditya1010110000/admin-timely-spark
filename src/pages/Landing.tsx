import { Brain, Calendar, Users, BookOpen, ArrowRight, CheckCircle } from "lucide-react";
...
const features = [
  {
    ...
    description: "Advanced algorithms create optimal timetables following NEP guidelines"
  },
  {
    icon: Calendar,
  ...
  },
  {
    ...
    description: "Separate interfaces for administrators, faculty, and students"
  },
  {
    icon: BookOpen,
    title: "NEP Compliance",
    description: "Built-in compliance with National Education Policy requirements"
  }
];
...
export default function Landing() {
  ...
  return (
    <div className="min-h-screen bg-gradient-subtle">
      ...
      <header className="bg-card border-b border-card-border">
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-xl font-bold">NEP Timetable System</h1>
      ...
      <section className="py-20 px-6">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-muted-foreground mb-8 max-w-2xl mx-auto leading-relaxed">
            Transform your academic scheduling with AI-powered timetable generation. 
            Create conflict-free, NEP-compliant schedules in minutes, not hours.
          </p>
      ...
      {/* Footer */}
      <footer className="bg-card border-t border-card-border py-8 px-6">
