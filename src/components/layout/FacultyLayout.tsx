...
const navigationItems = [
  { name: "My Schedule", href: "/faculty", icon: Calendar },
  { name: "Availability", href: "/faculty/availability", icon: Clock },
  { name: "My Courses", href: "/faculty/courses", icon: BookOpen },
  { name: "Requests/Swap", href: "/faculty/requests", icon: RefreshCw },
  { name: "AI Assistant", href: "/faculty/ai-assistant", icon: MessageSquare },
];
